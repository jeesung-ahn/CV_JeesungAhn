...
website: https://jeesung-ahn.github.io
github: jeesung-ahn
headcolor: "414141"
output: 
  vitae::awesomecv:
...
tribble(
  ~ degree, ~ uni, ~ loc, ~ dates, ~ details,
   "Ph.D. Candidate in Psychology", "University of Pennsylvania", "Philadelphia, PA", "Aug. 2019 - May 2024", list("Communication Neuroscience Laboratry (Advisor: Emily Falk, Ph.D.)",
         "Full-ride scholarship of approximately $400K")) %>% detailed_entries(degree, dates, uni, loc, details)
```
